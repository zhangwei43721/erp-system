  ...
  <el-table :data="afterSaleList" stripe style="width: 100%">
    ...
    <el-table-column fixed="right" label="操作" width="200">
      <template #default="scope">
        <el-button link size="small" type="primary" @click="openReplayDialog(scope.row.id)">处理
        </el-button>
        <el-button link size="small" type="primary" @click="loadQuestionReplayList(scope.row)">查看处理详情
        </el-button>
      </template>
    </el-table-column>
